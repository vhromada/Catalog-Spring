...
<form:form commandName="movie" method="POST" action="${pageContext.request.contextPath}/movies/edit" cssClass="form-horizontal">
    <fieldset>
        <form:input type="hidden" name="id" path="id" value="${movie.id}"/>
        <form:input type="hidden" name="position" path="position" value="${movie.position}"/>
