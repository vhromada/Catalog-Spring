...
/**
 * A class represents test for converter from {@link GameTO} to {@link GameFO}.
 *
 * @author Vladimir Hromada
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration("classpath:testWebConvertersContext.xml")
public class GameTOToGameFOConverterTest extends ObjectGeneratorTest {
    ...
    public void testConvert() {
        ...
        DeepAsserts.assertEquals(gameTO, gameFO);
    }
